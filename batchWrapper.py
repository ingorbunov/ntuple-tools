...
def main():
    ...
    parser.add_option('', '--outdir', dest='outDir', type='string',  default='/eos/cms/store/cmst3/group/hgcal/CMG_studies/Production/ilya/tdr/', help='output directory')
    ...
    queue = opt.queue
    # save working dir
    #outDir = '/eos/cms/store/cmst3/group/hgcal/CMG_studies/Production/ilya/tdr/'
    outDir = opt.outDir
